...
<div class="hero min-h-screen bg-base-200">
    <div class="hero-content flex-col flex-wrap lg:flex-row-reverse gap-14">
        <div class="shadow-lg rounded-lg p-12 dark:bg-slate-800 bg-white">
            <h1 class="text-5xl">Tabify</h1>
            <div class="py-6">
                Ever be jamming to a song on Spotify and have to Google the chords?
            </div>
            <div>
